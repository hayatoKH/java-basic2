...
public class UserVO {
	...
	// 그래서 SQL 테이터를 자바로 옮겨오기 위해서
	// 1. 담당할 테이블의 컬럼은 전부 변수로 만듭니다.
	...
	// 우클릭 -> source -> generate setter and getters(setter, getter)
	...
	// toString은 콘솔이나 화면에 UserVO를 찍었을 때 주소대신 내부 데이터가 나오도록 해 줍니다.
